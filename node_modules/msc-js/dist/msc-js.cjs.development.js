...
function _convertMINDToWMIND() {
  _convertMINDToWMIND = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(privateKey, amount) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          provider = new ethers.ethers.JsonRpcProvider(mainnet_rpc.http); // Connect wallet
          wallet = new ethers.ethers.Wallet(privateKey, provider);
          wmindContract = new ethers.ethers.Contract(contracts.WMIND_ADDRESS, WMIND, wallet); // Convert MIND to WMIND
          ethAmount = ethers.ethers.parseEther(amount.toString());
          overrides = {
...
function _convertWmindTomind() {
  _convertWmindTomind = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(privateKey, amount) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          provider = new ethers.ethers.JsonRpcProvider(mainnet_rpc.http);
          wallet = new ethers.ethers.Wallet(privateKey, provider);
          wethContract = new ethers.ethers.Contract(contracts.WMIND_ADDRESS, WMIND, wallet);
          wethAmount = ethers.ethers.parseEther(amount.toString());
          _context.next = 6;
...
function _getValidators() {
  _getValidators = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          vals = new ethers.ethers.Contract(contracts.STAKING_ADDRESS, STAKING, {
            provider: new ethers.ethers.JsonRpcProvider(mainnet_rpc.http)
          });
          _context.next = 3;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          stakeInmind = ethers.ethers.formatEther(stakeInWei);
...
exports.ABI = ABI;
exports.convertMINDToWMIND = convertMINDToWMIND;
exports.convertWmindTomind = convertWmindTomind;
exports.explorer = explorer;
exports.getStats = getStats;
exports.getValidators = getValidators;
exports.get_block = get_block;
exports.getstake = getstake;
exports.mainnet_rpc = mainnet_rpc;
exports.testnet_rpc = testnet_rpc;
//# sourceMappingURL=msc-js.cjs.development.js.map
